...
public class TemplateTest {
    private final SelenideElement searchAreaXpath = $(By.xpath("//textarea[@aria-label='Szukaj']"));
    private final SelenideElement searchAreaCss = $(By.cssSelector("[title='Szukaj']"));
    ...
    public void userOpensWebsite() {
        ...
        searchAreaCss.shouldBe(visible, Duration.ofSeconds(5));
        searchAreaXpath.shouldBe(visible, Duration.ofSeconds(5));
    }
